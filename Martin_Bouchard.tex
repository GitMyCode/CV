...
\cventre[1.2em]{2014}{Développeur Web}{Contrat}{ Un re-design d'une page web pour un avocat. Le client voulait un design plus moderne qui serait \emph{ responsive design } pour les visiteurs mobiles. \href{http://www.avocatcriminel.ca/}{www.avocatcriminel.ca}}
...
\item Jeu de Puissance4 avec un A.I. minmax et une interface. Le jeu a été conçu dans le cadre d'un cours sur les designs patterns. Il y a notamment: Strategy, Command, Memento, Factory, Facade \small \href{https://github.com/GitMyCode/puissance4}{github.com/GitMyCode/puissance4}

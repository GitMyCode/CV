...
\cventre[1.2em]{2014}{Développeur Web}{Contrat}{ Un re-design d'une page web pour un avocat. Le client voulait un design plus moderne et adaptatif (\emph{responsive design}) pour les visiteurs mobiles. \href{http://www.
...
{$\bullet$ Design d'interface utilisateur  $\bullet$ Programmation front-end et back-end(Apex) de pages web \\$\bullet$ Conception de schéma bd  $\bullet$ Intégration avec LDAP $\bullet$ Architecture d'applications sous forme de services}
...
\vspace{1em}
%\begin{comment}
\cvdoubleitem{Programmation}{Java,Groovy, Scala, Python, C/C++, Assembleur, BASH, Ruby}
			 {Système}{Windows, Linux}\vspace{1em}
\cvdoubleitem{Framework web}{Grails, Apex, Django, Wordpress, Ruby on Rails, Play}

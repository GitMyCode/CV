...
%CVBOXITEM--------------------------------
\newcommand{\cvboxitem}[4]{}
\renewcommand{\cvboxitem}[4]{%
	\begin{minipage}[t]{\linewidth}
	$\bullet$ \textbf{#1}
	\ifthenelse{\equal{#2}{}}{}{, {\slshape #2}}\par%	
	\raggedright{\scriptsize\href{#3}{#3}}\vspace{1em}\\
	{#4}
	\end{minipage}
...
\cventre[1.3em]{2014}{Stagiaire}{Telica Software}
					 {Développeur back-end et front-end sur une application web en Ruby on Rails }
					 {$\bullet$ TDD $\bullet$ Développement Agile $\bullet$ Architecture MVC  }
...
\cvdoubleitem{programmation:}{Java, Python, C/C++, Assembleur, BASH, Ruby}
			 { web:}{HTML/css/php/javascript, jQuery Mobile}
\cvdoubleitem{cms:}
			 {Apex, Django, Wordpress, Ruby on Rails}{system:}{Windows, Linux}
...
\cvdetaillist{Java}{
\begin{itemize}
\item Jeu de Connect4 avec un AI minmax et interface. Le jeu a été conçu dans le cadre d'un cours sur les designs pattern. Il y a notamment: Strategy, Command, Memento, Factory, Facade \small \href{https://github.com/GitMyCode/puissance4}{https://github.com/GitMyCode/puissance4}
\item Programmes Java utilisant  JPA et JDBC 
\item Intelligence artificielle du jeu Connect5(\textit{Go-Moku}) \small \href{https://github.com/GitMyCode/INF4230}{https://github.com/GitMyCode/INF4230}
\end{itemize}
}
...
\cvtriplebox
{\cvboxitem{Site web}{en construction}{www.courspiano.ca}{Un site construit sur la plateforme Wordpress. Design fait sur photoshop puis realisé en theme-wordpress}}
{\cvboxitem{Site web}{en construction}{coursmusique.codefaction.webfactional.com}{Un site designé sur photoshop et transposé en html/css. Le back-end est fait sur la plateforme Django}}
{\cvboxitem{Encefal}{projet en collaboration}{http://foireauxlivres.uqam.ca/}{La foire aux livres permet aux etudiants de vendre leurs livres à d'autres étudiants. La plateforme est Django.}}

\cvtriplebox
{\cvboxitem{Programming Mobile Applications for Android Handheld Systems}{}{https://class.coursera.org/android-001}
...
{\cvboxitem{MineSweeper AI}{}{https://github.com/GitMyCode/Minesweeper-AI}
{Un projet initialement personnel qui a été repris pour un projet de fin de session d'un cours d'Intelligence Artificiel}
}
{
\cvboxitem{Site Web}{contrat}{http://www.avocatcriminel.ca/}{https://github.com/GitMyCode/avocatmontreal}

...
%cvprojectitem----------------------------------
\newcommand{\cvprojectitem}[3][0.5em]{
...
\small{ Simetryk est une plateforme \textit{SAS} \textit{multi-tetant} et personnalisable de gestion centralisé de fournisseur.} \vspace{1em}\newline{} 
...
\begin{flushright}{\rmfamily\textsl{Technologies: C\#/Asp.net, React, Micro-services}}\end{flushright}
\vspace{1em}
...
\begin{flushright}{\rmfamily\textsl{Technologies: C\#/Asp.net, React, Micro-services, Sql/server, Azure Directory}}\end{flushright}
\vspace{1em}
...
\cvprojectitem{Front-end (React)}{Je suis un des contributeurs principaux au développement front-end de ce projet. Supervise la qualité du code ainsi que les decisions critiques dans l'évolution de l'architecture}
\cvprojectitem{Event sourcing}{Tout notre architecture back-end (de ce microservice) utilise les techniques du \textit{Event sourcing}. Cela nous donne l'avantage de maintenir un model très similaire à celui 
qui a été discuté lors du \textit{Event storming}.}
\vspace{1em}

...
\small{Modernisation de leur ancien système pour un nouveau en mode SAS. Le nouveau système devait avoir toute les fonctionnalitées de l'ancien, mais avec des améliorations de vitesse plus d'autres fonctionnalité} \vspace{1em}\newline{} 
\begin{tabular*}{\linewidth}{p{\dimexpr 0.20\linewidth-1\tabcolsep }
		p{\dimexpr 0.84\linewidth-1\tabcolsep }} 
	\fontsize{8}{9}\textit{BD (SQL)} & \small{Scriptes sql complexe afin d'optimiser certaines mise-à-jour dont la performance était importante.} \vspace{0.3em}\\
	\fontsize{8}{9}\textit{Front-end (Knockout)} & \small{Mécanique d'édition et de d'annulation d'une modification.} \vspace{0.3em}\\
	\fontsize{8}{9}\textit{Front-end (Knockout)} & \small{Développer une interface et une mécanique de recherche avancée.} \vspace{0.3em}\\
	\fontsize{8}{9}\textit{C\#, rdlc, Entity-Framework} & \small{Développement de mécanismes de générations de rapport.} 
...
\begin{tabular*}{\linewidth}{p{\dimexpr 0.13\linewidth-1\tabcolsep }
	...
	\textbf{Système de gestion pour FNCM} &  \vspace{-0.5em}
	\begin{itemize}
		
		\item Modernisation de leur ancien système pour un nouveau en mode SAS. Le nouveau système devait avoir toute les fonctionnalitées de l'ancien, mais avec des améliorations de vitesse plus d'autres fonctionnalité 
